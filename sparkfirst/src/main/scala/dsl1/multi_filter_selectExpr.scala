...
object multi_filter_selectExpr {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //Read allcountry.csv
    //    instead of tdate fetch year and rename column year
    //    Another requirement at the end of the dataframe
